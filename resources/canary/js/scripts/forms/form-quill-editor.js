...
(function (window, document, $) {
  ...
  var newstickerEditor = new Quill('#full-container .newstickereditor', {
    bounds: '#full-container .newstickereditor',
    modules: {
      formula: true,
      syntax: true,
      toolbar: [
  ...
  var editors = [bubbleEditor, snowEditor, fullEditor, newstickerEditor];
